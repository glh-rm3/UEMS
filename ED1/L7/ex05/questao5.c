...
5. Escreva uma função para achar o MAIOR número em uma árvore binária NÃO ordenada.
****************************************************************************************************/
...
// utilizei uma fila como estrutura auxiliar,
// pois o melhor caso para essa operação
// é consultar todos os nós da árvore primeiro,
// para depois comparar todos em uma outra estrutura
int maior_num(ArvBin *raiz) {
    if(raiz == NULL || 
       *raiz == NULL) {
        return 0;
    }
